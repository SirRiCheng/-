...
import { extractReadableTextByFileName, structureFileContentWithLlm } from "@/lib/llm-structure";
...
export async function POST(request: Request) {
  try {
    ...
    const payload = isExcel
      ...
      : await structureFileContentWithLlm(fileName, extractReadableTextByFileName(buffer, fileName));
